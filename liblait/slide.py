...
class Slide(static.Static):
    def __init__(self,x,y,w,h, settings,flipped, name, image, rows=None, cols=None, row=0, fpf=5, game=None):
        ...
        static.Static.__init__(self, x, y, w, h, settings, name, image, rows=rows, cols=cols, row=row, fpf=fpf, game=game)
